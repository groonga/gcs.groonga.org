...
By the way, yesterday we posted a [short tutorial](/blog/2012/07/25/initial-release/work-with-aws-cloud-search-gem/) to use Groong CloudSearch via [aws\_cloud\_search](https://github.com/spokesoftware/aws\_cloud\_search), a client library for Amazon CloudSearch. You'll be able to try Groonga CloudSearch more easily, if you're familiar with development on the Ruby langugage.
